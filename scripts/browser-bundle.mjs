...
export async function browserBundle({ benchmark = false } = {}) {
  ...
  const specs=[
    ...
    ['evidenceAlgebra','src/evidence-algebra.mjs','const {planReconstruction}=modules.reconstruction;const {inferEvidenceInterface}=modules.evidenceInterface;','createEvidenceAlgebra'],
