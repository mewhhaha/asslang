...
export async function browserBundle({ benchmark = false } = {}) {
  ...
  const specs=[
    ...
    ['differential','src/differential.mjs','','forwardLinearize,reusableLinearize,valueAndGradient,stopGradient'],
    ['intrinsics','src/intrinsics.mjs','const {forwardLinearize,reusableLinearize,valueAndGradient,stopGradient}=modules.differential;','intrinsicArities,inferIntrinsic,stageIntrinsic'],
