...
export async function browserBundle({ benchmark = false } = {}) {
  ...
  const specs=[
    ['recordUpdateCases','test/record-updates-cases.mjs','','recordUpdateCases,recordUpdateModes'],
    ['recordUpdateChecks','test/record-updates-browser.mjs','const {recordUpdateCases,recordUpdateModes}=modules.recordUpdateCases;','runRecordUpdateBrowserChecks'],
  ...
  if(benchmark) {
    ...
    code+='const {runRecordUpdateBrowserChecks}=modules.recordUpdateChecks;';
