...
export async function browserBundle({ benchmark = false } = {}) {
  ...
  const specs=[
    ...
    ['differential','src/differential.mjs','','forwardLinearize,valueAndGradient,stopGradient'],
    ['intrinsics','src/intrinsics.mjs','const {forwardLinearize,valueAndGradient,stopGradient}=modules.differential;','intrinsicArities,inferIntrinsic,stageIntrinsic'],
