...
export async function browserBundle({ benchmark = false } = {}) {
  ...
  const specs=[
    ...
    ['evidenceAlgebra','src/evidence-algebra.mjs','const {planReconstruction}=modules.reconstruction;const {inferEvidenceInterface}=modules.evidenceInterface;const {planEvidenceRefinement,verifyEvidenceRefinement}=modules.evidenceRefinement;const {auditEvidenceTransport,liftEvidenceTransport}=modules.evidenceTransport;','createEvidenceAlgebra'],
