...
> Historical draft on the pre-#34 base. Current behavior and validation are in
> [Chunk scan integration](CHUNK-SCAN-INTEGRATION.md). In particular, structural
> guards preflight and per-item reductions remain rejected.
